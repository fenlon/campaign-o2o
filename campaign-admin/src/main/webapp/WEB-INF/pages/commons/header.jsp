	...
	<div class="container">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand"
				href="${pageContext.request.contextPath }/index.htm">首页</a>
		</div>
		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav">
				<li><a href="http://120.25.230.36:8080/campaign_qrcode/"
			...
			<ul class="nav navbar-nav navbar-right">
				<c:choose>
					<c:when test="${empty currentUser }">
						<li><a
							href="${pageContext.request.contextPath }/login/index.htm">登录</a></li>
						<li><a
							href="${pageContext.request.contextPath }/register/index.htm">注册</a></li>
					</c:when>
					<c:otherwise>
						<li><a
