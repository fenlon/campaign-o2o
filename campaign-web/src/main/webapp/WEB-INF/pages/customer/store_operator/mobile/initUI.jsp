...
<script type="text/javascript"
	src="${pageContext.request.contextPath }/resources/js/customer/store_operator/init.js"></script>
</head>
<body ng-app="initModule">
	<div class="container-fluid">
		<div class="alert alert-danger text-center" role="alert">
			<strong>初始化</strong>
		</div>
		<div class="alert alert-warning" role="alert">
			<form class="form-horizontal" ng-controller="initCtrl" name="opeForm">
				...
				<div class="form-group"
					ng-class="{'has-error':opeForm.passwordConfirm.$dirty && opeForm.passwordConfirm.$invalid}">
					<div class="col-sm-12">
						<input type="password" autocomplete="off" name="passwordConfirm"
							ng-required="true" class="form-control"
							ng-model="ope.passwordConfirm" placeholder="确定密码" />

						<div
							ng-show="opeForm.password.$dirty && opeForm.passwordConfirm.$dirty && ope.password !== ope.passwordConfirm"
							class="alert alert-danger help-block">
							<p>确认密码与密码不一致</p>
						</div>
					</div>
				...
				<div class="form-group">
					<div class="col-sm-12 text-center">
						<button type="button" ng-click="doInit()"
							class="btn btn-primary btn-lg btn-block"
							ng-disabled="opeForm.$invalid">确定提交</button>
					</div>
				</div>
			</form>
		</div>
