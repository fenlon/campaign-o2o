...
indexModule.controller("indexController", ['$scope', '$http',
				function($scope, $http) {
					...
					$scope.generateCode = function(content) {
						...
						$scope.qrcode.foregroundColor = parseInt($scope.fore,
								16);
						$scope.qrcode.backgroundColor = parseInt($scope.back,
								16);
						...
						$scope.codeUrl = encodeURI(baseUrl + content
								...
								+ "&foregroundColor="
								+ $scope.qrcode.foregroundColor
								+ "&backgroundColor="
								+ $scope.qrcode.backgroundColor + "&logoUrl="
